/*---------------------------------------------------------
------mmmm---mmmm-aaaaaaaa----ddddddddd----------PPPPPPPPPP----LLLL--------------AAA------YYY------YYY----EEEEEEEEEEE-----RRRRRRRRRR--------->}
     mmmmmmmmmmmm aaaaaaaaa   dddddddddd	     PPP    PPP    LLLL             AAAAA      YYY    YYY     EEE             RRR    RRR          }Name: MAD PLAYER MOVEMENT
     mmm mmmm mmm aaa    aaa  ddd     ddd	     PPP    PPP    LLLL            AA   AA      YYY  YYY      EEEEEEEEEEE     RRR    RRR          }Author: Nyan Cat
    mmm  mmm  mmm aaaaaaaaaaa ddd     ddd	     PPPPPPPPPP    LLLL           AAAAAAAAA       YYYY        EEEEEEEEEEE     RRRRRRRRRR          }Project Start: September 28th 2013
    mmm       mmm aaa     aaa dddddddddd	     PPP           LLLLLLLLLL    AAA     AAA       YY         EEE             RRR     RRR         }File: mad_Player.lua
---mmm--------mmm-aaa-----aaa-ddddddddd-- -------PPP-----------LLLLLLLLLL---AAA-------AAA------YY---------EEEEEEEEEEE-----RRR------RRR------->}
---------------------------------------------------------*/

AddCSLuaFile("autorun/PlayerMoveModification.lua")
...
local BS = net.ReadBit() == 1 -- Lol bs, Bull shit :3

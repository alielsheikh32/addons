...
THEME.ServerBar = function( s,w,h )
	...
	draw.SimpleText( s.Label or "HatsChat2", "HatsChatPrompt", 6, 1, HatsChat.ChatBoxCol.Candy2, TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM )
	draw.SimpleText( s.Label or "HatsChat2", "HatsChatPrompt", 5, 0, HatsChat.ChatBoxCol.Candy1, TEXT_ALIGN_LEFT, TEXT_ALIGN_BOTTOM )
end
